...
理論を知らない第3者が下手にいじるとbakaって出てくる、それはそれで一興だ。
これは自分にムチを打つための仕掛けで、他人を罵倒するためではない。
それに私自信もハッシュ関数とか第三者の作ったものを流用しているけど、それはわかりやすく使いやすい実装で一目見れば何をするかが解るからという基準だ。
とてもコードがきれいとかそんな基準で選べる立場じゃない。
そもそもどういうコードがきれいなのか、数学の美しさみたいな感覚が私にはないのだ。
だから使えるやつから使う。プログラムなんか動けばいいのだ。
